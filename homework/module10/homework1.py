...
word_count - количество записываемых слов, file_name - название файла,
...
thr_first = Thread(target=wite_words, args=(10, 'example6.txt'))
thr_second = Thread(target=wite_words, args=(30, 'example7.txt'))
thr_third = Thread(target=wite_words, args=(200, 'example8.txt'))
thr_fourth = Thread(target=wite_words, args=(100, 'example9.txt'))
