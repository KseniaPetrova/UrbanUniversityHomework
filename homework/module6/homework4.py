...
class Figure:
    ...
    def __is_valid_sides(self, *sides):
        if isinstance(sides, int) and sides > 0:
            return True  # возвращает True если все стороны целые положительные числа и кол-во новых сторон совпадает
            # с текущим
        else:
            return False
...
class Circle(Figure):
    ...
    def __init__(self, __sides, __color, filled: bool, __radius):
